...
schedule.every().day.at("20:00").do(start_timelapse, 12)
schedule.every().day.at("21:00").do(start_timelapse, 13)
schedule.every().day.at("22:00").do(start_timelapse, 14)
schedule.every().day.at("23:00").do(start_timelapse, 15)
schedule.every().day.at("00:00").do(start_timelapse, 16)
schedule.every().day.at("01:00").do(start_timelapse, 17)
schedule.every().day.at("02:00").do(start_timelapse, 18)
schedule.every().day.at("03:00").do(start_timelapse, 19)
schedule.every().day.at("04:00").do(start_timelapse, 20)
schedule.every().day.at("05:00").do(start_timelapse, 21)
schedule.every().day.at("06:00").do(start_timelapse, 22)
schedule.every().day.at("07:00").do(start_timelapse, 23)
